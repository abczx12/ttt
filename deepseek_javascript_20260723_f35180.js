...
// Sóng nhảy trong GUI + UI Trắng Đen + Phát MP3 + Icon ☯️
...
(function () {
    ...
    function toggleMusic() {
        ...
        try {
            ...
            musicGain.gain.value = 0.5; // Volume mặc định
            ...
            document.getElementById('music-status').textContent = '▶ Đang phát';
            document.getElementById('music-status').style.color = '#888';
        } catch (err) {
    ...
    const UI = {
        ...
        init() {
            ...
            toggleBtn.onmouseenter = () => {
                ...
                toggleBtn.style.boxShadow = '0 0 60px rgba(255,255,255,0.1)';
            };
            ...
            <div id="kh-body">
                ...
                <div style="display:flex;gap:6px;margin-bottom:12px;align-items:center;">
                    <input type="file" id="music-file" accept="audio/*" style="flex:1;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.1);color:#fff;border-radius:4px;padding:4px 8px;font-size:11px;">
                    <button id="music-play" style="padding:4px 12px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);color:#fff;border-radius:4px;cursor:pointer;font-size:11px;">▶ PLAY</button>
